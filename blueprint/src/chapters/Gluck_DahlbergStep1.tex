...
% archon:covers Gluck/Euclidean/DahlbergStep1.lean
...
[Periodicity and integrability of $f$ and $k_{a,b}$]
  ...
  \lean{Gluck.cleanBicircle_periodic, Gluck.cleanBicircle_bounds}
  % Lean (private, not pinned): dahlbergF_periodic, dahlbergF_intervalIntegrable, cleanBicircle_intervalIntegrable
...
[On-period value of $f$ and the period integrals]
  ...
  % Lean (private, not pinned): integral_cleanBicircle, dahlbergF_on_period, integral_dahlbergF
  \uses{def:dahlberg_f, def:clean_bicircle}
...
[Uniform bound of a continuous periodic curvature]
  ...
  % Lean (private, not pinned): exists_kappa_bound
...
[Mixed-sign level extraction]
  ...
  % Lean (private, not pinned): exists_alignmentData
...
[Analytic core: the $L^1$ $\eta$-construction]
  ...
  % Lean (private, not pinned): exists_eta_clean_L1
