...
\begin{lemma}[Canonical step-curvature values on the four arcs]
  \label{lem:step_curvature_canonical_values}
  \lean{Gluck.stepCurvature_canonical_values}
  \uses{def:four_arc_step_function}
...
\begin{lemma}[Existence of a common plateau radius]
  \label{lem:exists_plateau_radius}
  \lean{Gluck.exists_plateau_radius}
...
\begin{lemma}[Total measure of the four plateau intervals]
  \label{lem:plateau_union_measure}
  \lean{Gluck.plateau_union_measure}
