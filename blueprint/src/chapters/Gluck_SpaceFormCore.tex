...
\gluckfigure{spaceform-unification}
  {One marked curvature profile reconstructed as intrinsic curves $\gamma_K$ in
   the spherical, Euclidean, and hyperbolic space forms. Their conformal-chart
   representatives $z_K=\chi_K\circ\gamma_K$ enter the unified curvature law,
   which passes continuously through the flat case $K=0$.}
  {A shared curvature graph sits above intrinsic spherical, Euclidean, and
   hyperbolic curves with corresponding numbered points. Labels distinguish
   each gamma curve from its conformal chart coordinate z.}
