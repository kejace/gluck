...
\begin{lemma}[speed Lipschitz bound, uniform in the curvature]
  \label{lem:truncated_speed_lipschitz_uniform}
  \lean{Gluck.truncatedSpeed_lipschitz_uniform}
...
\begin{lemma}[field Lipschitz bound, uniform in the curvature]
...
[uniform margins of the step model near the centered circle]
  ...
  The sole stage-1 consumer, \cref{lem:spherical_endpoint_winding}, supplies
...
\begin{lemma}\leanok
[spherical endpoint winding: closed admissible trajectory for the
