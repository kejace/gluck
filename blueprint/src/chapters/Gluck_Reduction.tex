...
\gluckfigure{degree-one-reparametrization}
  {A degree-one circle diffeomorphism redistributes parameter time without
   changing cyclic order or curvature values. Numbered extrema retain their
   correspondence under composition with the increasing lift.}
  {The original curvature graph, an increasing periodic lift, and the
   horizontally redistributed curvature graph with matching numbered extrema.}
  {fig:degree_one_reparametrization}
