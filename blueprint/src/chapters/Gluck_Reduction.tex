\chapter{Closing the $\kappa$-curve: the reduction is justified}
\label{chap:reduction}

% archon:covers Gluck/Reduction.lean
...
\cref{cor:closing_configuration_exists} from \cref{chap:winding}, which imports
...
\noindent\emph{The genuine remaining construction.} \cref{cor:closing_configuration_exists}
...
\section{The breakpoint-aligning reparametrization family $g_z$}
...
[Calibrated speed density $w_z$]
  ...
  \lean{Gluck.alignDensity, Gluck.clampTent, Gluck.arccos_cos_abs,
        Gluck.alignN1, Gluck.alignN2, Gluck.alignN3, Gluck.alignN4,
        Gluck.alignL1, Gluck.alignL2, Gluck.alignL3, Gluck.alignL4,
        Gluck.alignC1, Gluck.alignC2, Gluck.alignC3, Gluck.alignC4,
        Gluck.alignHt, Gluck.alignHt_eq}
...
[Density is well-behaved]
  ...
  \lean{Gluck.continuous_uncurry_alignDensity, Gluck.continuous_alignDensity_theta,
        Gluck.alignDensity_periodic, Gluck.alignDensity_ge, Gluck.alignHt_bounds,
        Gluck.alignL_bounds, Gluck.continuous_alignHt,
        Gluck.continuous_alignN1, Gluck.continuous_alignN2, Gluck.continuous_alignN3,
        Gluck.continuous_alignN4, Gluck.continuous_alignL1, Gluck.continuous_alignL2,
        Gluck.continuous_alignL3, Gluck.continuous_alignL4, Gluck.continuous_alignC1,
        Gluck.continuous_alignC2, Gluck.continuous_alignC3, Gluck.continuous_alignC4,
        Gluck.continuous_clampTent, Gluck.continuous_clampTent_theta,
        Gluck.clampTent_nonneg, Gluck.clampTent_le_one, Gluck.clampTent_periodic,
        Gluck.alignDensity_le, Gluck.alignHt_le, Gluck.alignHt_nonneg}
...
[Exact arc integrals]
  ...
  \lean{Gluck.alignDensity_arc1, Gluck.alignDensity_arc2, Gluck.alignDensity_arc3,
        Gluck.alignDensity_arc4, Gluck.alignDensity_period_integral,
        Gluck.alignDensity_integral_split, Gluck.clampTent_centered_integral,
        Gluck.clampTent_integral_support, Gluck.clampTent_integral_eq_zero,
        Gluck.clampTent_eq_zero, Gluck.half_le_arccos_cos}
  \uses{def:align_density}
...
[Node values of $g_z$]
  ...
  \lean{Gluck.alignReparam_node_values}
...
[Quasi-periodicity of $g_z$]
  ...
  \lean{Gluck.alignReparam_add_two_pi}
  \uses{def:align_reparam, lem:align_density_arc_integral}
...
[Continuity of $g_z$ in $\theta$]
  ...
  \lean{Gluck.continuous_alignReparam}
...
[Joint continuity of $(z,\theta)\mapsto g_z(\theta)$]
  ...
  \lean{Gluck.continuous_uncurry_alignReparam}
  \uses{def:align_reparam, lem:align_density_props}
...
[Strict monotonicity of $g_z$ on the disk]
  ...
  \lean{Gluck.strictMono_alignReparam}
  \uses{def:align_reparam, lem:align_density_props}
...
[$g_z$ aligns the step functions]
  ...
  \lean{Gluck.kappaZero_comp_alignReparam}
...
\section{The $\kappa$-error map over the disk}
...
[$E_\kappa$ is continuous on the disk]
  ...
  \lean{Gluck.continuous_kappaErrorMap}
...
\section{Change-of-variables keystones for the $L^1$ estimate}
...
[FTC derivative of $g_z$]
  ...
  \lean{Gluck.hasDerivAt_alignReparam}
  \uses{def:align_reparam, lem:align_density_props}
...
[$E_\kappa$ is uniformly close to $E_{\mathrm{bi}}$]
  ...
  \lean{Gluck.kappaErrorMap_sub_errorMap_le}
...
[Existence of a preconditioning reparametrization]
  ...
  \lean{Gluck.exists_reparam_kappaErrorMap_close, Gluck.curvature_bounds,
        Gluck.recip_diff_abs_le, Gluck.integrableOn_of_measurable_bounded,
        Gluck.measurable_stepCurvature_canonical}
...
[Reduction is justified]
  ...
  \uses{lem:abab_values, lem:exists_preliminary_reparam, def:kappa_error_map,
        ...
        thm:existence_of_zero, lem:closes_iff}
  ...
  has $E(\rho)=0$; so by \cref{lem:closes_iff} the reconstruction curve
...
\begin{proof}
  \uses{lem:abab_values, lem:exists_preliminary_reparam, lem:exists_reparam_close,
        lem:kappa_error_map_continuous, lem:kappa_error_map_close,
        lem:error_map_winds_boundary, thm:existence_of_zero, lem:closes_iff,
  ...
  \cref{lem:closes_iff} the reconstruction $\alpha_{1/(\kappa\circ h)}$ then closes
