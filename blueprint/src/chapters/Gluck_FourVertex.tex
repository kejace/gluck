...
% archon:covers Gluck/FourVertex.lean
...
\begin{theorem}[Gluck's converse, strictly positive case]
  ...
  \leanok
  \uses{def:is_curvature_function, def:four_vertex_condition, def:is_simple_closed, def:realizes_curvature, lem:realizes_curvature_reconstruct, lem:realizes_curvature_comp, lem:is_simple_closed_comp, lem:exists_c1_circle_inverse}
...
\begin{proof}
  \uses{lem:closes_iff, lem:abab_values, def:realizes_curvature, lem:realizes_curvature_signedCurvature, def:reconstruct, def:error_vector, lem:reduction_justified, cor:closing_configuration_exists, cor:positive_curvature_implies_simple, lem:reconstruct_const, lem:realizes_curvature_reconstruct, lem:realizes_curvature_comp, lem:is_simple_closed_comp, lem:exists_c1_circle_inverse}
  \leanok
  ...
  By \cref{lem:closes_iff} the reconstruction $\alpha_\rho$ closes up; it is the
...
\cref{thm:gluck_converse}. They live in \texttt{Gluck/FourVertex.lean}.

\begin{lemma}\leanok
[The reconstruction realizes its curvature]
  \label{lem:realizes_curvature_reconstruct}
  \lean{Gluck.realizesCurvature_reconstruct}
...
\begin{lemma}[Simplicity transfers under an orientation-preserving circle reparametrization]
  ...
  \lean{Gluck.isSimpleClosed_comp, Gluck.periodic_eq_imp_sub_zsmul, Gluck.psi_add_int_period, Gluck.eq_zero_of_window_sub_eq_zsmul}
