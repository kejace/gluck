...
\illustrationpage{spaceform-unification}
  ...
  {The same periodic intrinsic curvature $\kappa_K\equiv2$ produces geodesic
   circles with different radii in $S^2$, $\mathbb E^2$, and $H^2$. The four
   numbered points are equal quarter-period samples, not curvature extrema.}
