...
\illustrationpage{spaceform-unification}
  ...
  {A single profile and its marked vertices are followed through intrinsic
   curves $\gamma_K$ in the three space forms. Their chart coordinates
   $z_K=\chi_K\circ\gamma_K$ enter the conformal curvature law, which varies
   continuously with ambient curvature $K$ through the flat case.}
