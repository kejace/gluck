...
package by splitting the Euclidean Dahlberg component into its CDFV, Lemma 8,
and non-strict §4 source gates. -/
...
theorem signedMengerProfile_dahlbergFourVertex_E2_not_constant_strict_of_forwardDfvSources
    (hsrc : ForwardDfvGeometricSources)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
    (hregular : DahlbergRegular v)
...
theorem signedMengerProfile_constant_or_dahlbergFourVertex_E2_strict_of_forwardDfvSources
    (hsrc : ForwardDfvGeometricSources)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
    (hregular : DahlbergRegular v)
  ...
  · exact Or.inl hconst
  · exact Or.inr
      (signedMengerProfile_dahlbergFourVertex_E2_not_constant_strict_of_forwardDfvSources
...
theorem dahlberg_discrete_four_vertex_E2_strict_of_forwardDfvSources
  ...
  exact signedMengerProfile_constant_or_dahlbergFourVertex_E2_strict_of_forwardDfvSources
...
theorem dahlberg_discrete_four_vertex_E2_strict_not_constant_of_forwardDfvSources
  ...
  exact signedMengerProfile_dahlbergFourVertex_E2_not_constant_strict_of_forwardDfvSources
...
theorem constant_or_dahlbergFourVertex_E2_conformalMenger_zero_strict_of_forwardDfvSources
    (hsrc : ForwardDfvGeometricSources)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
    (hregular : DahlbergRegular v)
  ...
  exact constant_or_dahlbergFourVertex_of_eq_affine
    ...
    (signedMengerProfile_constant_or_dahlbergFourVertex_E2_strict_of_forwardDfvSources
      hsrc hn v hsimple hregular horient)
...
theorem dahlbergFourVertex_E2_conformalMenger_zero_strict_of_forwardDfvSources
    (hsrc : ForwardDfvGeometricSources)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
    (hregular : DahlbergRegular v)
  ...
  exact dahlbergFourVertex_of_constant_or_of_not_constant
    (constant_or_dahlbergFourVertex_E2_conformalMenger_zero_strict_of_forwardDfvSources
...
theorem dahlberg_discrete_four_vertex_E2_conformalMenger_zero_strict_of_forwardDfvSources
    (hsrc : ForwardDfvGeometricSources)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
    (hregular : DahlbergRegular v)
...
theorem constant_or_dahlbergFourVertex_conformalMenger_spaceForm_kernel_of_forwardDfvSources
    (hsrc : ForwardDfvGeometricSources)
    {ε : ℝ} (hε : ε = 0 ∨ ε = 1 ∨ ε = -1)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
  ...
  · rcases hrest with hS | hH
    ...
    · subst ε
      exact constant_or_dahlbergFourVertex_spaceForm_kernel_of_forwardDfvSources
        hsrc (ε := -1) (Or.inr rfl) hn v κ hdisk hsimple horient hregular hκ hproper
      ...
      · exact Or.inr
          (dahlbergFourVertex_of_orderedAdjacentTurns_four_le hn
            (orderedAdjacentTurns_spaceForm_of_sources
              hsrc (ε := 1) (Or.inl rfl) hn v κ hdisk hsimple horient
              hregular hκ (by intro hlt; norm_num at hlt) hconst))
    · subst ε
      by_cases hconst : ∃ c, ∀ i : ZMod n, κ i = c
      · exact Or.inl hconst
      · exact Or.inr
          (dahlbergFourVertex_of_orderedAdjacentTurns_four_le hn
            (orderedAdjacentTurns_spaceForm_of_sources
              hsrc (ε := -1) (Or.inr rfl) hn v κ hdisk hsimple horient
              hregular hκ hproper hconst))

/-- The source-parametrized positive-orientation conformal-Menger nonconstant
Dahlberg kernel over `E²`, `S²`, and `H²`. -/
theorem dahlbergFourVertex_conformalMenger_spaceForm_kernel_of_forwardDfvSources
    (hsrc : ForwardDfvGeometricSources)
    {ε : ℝ} (hε : ε = 0 ∨ ε = 1 ∨ ε = -1)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
...
/-- Exact public-name alias for the DFV-source-parametrized
positive-orientation conformal-Menger constant-or-Dahlberg theorem. -/
theorem
    constant_or_dahlbergFourVertex_conformalMenger_spaceForm_pos_of_forwardDfvSources
    (hsrc : ForwardDfvGeometricSources)
    {ε : ℝ} (hε : ε = 0 ∨ ε = 1 ∨ ε = -1)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
...
/-- Exact public-name alias for the DFV-source-parametrized
positive-orientation conformal-Menger nonconstant D4VT theorem. -/
theorem
    dahlbergFourVertex_conformalMenger_spaceForm_pos_of_forwardDfvSources
    (hsrc : ForwardDfvGeometricSources)
    {ε : ℝ} (hε : ε = 0 ∨ ε = 1 ∨ ε = -1)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
...
/-- Exact public-name alias for the DFV-source-parametrized
negative-orientation conformal-Menger constant-or-Dahlberg theorem. -/
theorem
    constant_or_dahlbergFourVertex_conformalMenger_spaceForm_neg_of_forwardDfvSources
    (hsrc : ForwardDfvGeometricSources)
    {ε : ℝ} (hε : ε = 0 ∨ ε = 1 ∨ ε = -1)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
...
/-- Exact public-name alias for the DFV-source-parametrized
negative-orientation conformal-Menger nonconstant D4VT theorem. -/
theorem
    dahlbergFourVertex_conformalMenger_spaceForm_neg_of_forwardDfvSources
    (hsrc : ForwardDfvGeometricSources)
    {ε : ℝ} (hε : ε = 0 ∨ ε = 1 ∨ ε = -1)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
...
/-- Exact public-name alias for the DFV-source-parametrized
strict-orientation conformal-Menger constant-or-Dahlberg theorem. -/
theorem
    constant_or_dahlbergFourVertex_conformalMenger_spaceForm_strict_of_forwardDfvSources
    (hsrc : ForwardDfvGeometricSources)
    {ε : ℝ} (hε : ε = 0 ∨ ε = 1 ∨ ε = -1)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
...
/-- Exact public-name alias for the DFV-source-parametrized
strict-orientation conformal-Menger nonconstant D4VT theorem. -/
theorem
    dahlbergFourVertex_conformalMenger_spaceForm_strict_of_forwardDfvSources
    (hsrc : ForwardDfvGeometricSources)
    {ε : ℝ} (hε : ε = 0 ∨ ε = 1 ∨ ε = -1)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
...
theorem dahlbergFourVertex_conformalMenger_spaceForm_of_negativeOrientation_of_sources
    ...
    DahlbergFourVertex κ := by
  exact dahlbergFourVertex_of_constant_or_of_not_constant
    (constant_or_dahlbergFourVertex_conformalMenger_neg_of_sources
      hsrc hε hn v κ hdisk hsimple horient hregular hκ hproper)
    hnc
...
theorem constant_or_dahlbergFourVertex_S2_neg_reflected_of_sources
  ...
  exact constant_or_dahlbergFourVertex_conformalMenger_spaceForm_kernel_of_sources
    hsrc
    (ε := 1) (Or.inr (Or.inl rfl)) hn (ReverseCyclicPolygon v)
...
endpoint, stated for the reflected profile `i ↦ -κ(-i)`. -/
theorem constant_or_dahlbergFourVertex_S2_neg_reflected_of_forwardDfvSources
    (hsrc : ForwardDfvGeometricSources)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
...
endpoint, stated for the reflected profile `i ↦ -κ(-i)`. -/
theorem dahlbergFourVertex_S2_neg_reflected_of_forwardDfvSources
    (hsrc : ForwardDfvGeometricSources)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
...
/-- The DFV-source-parametrized S² positive-orientation constant-or-Dahlberg
endpoint. -/
theorem constant_or_dahlbergFourVertex_S2_pos_of_forwardDfvSources
    (hsrc : ForwardDfvGeometricSources)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
...
endpoint. -/
theorem dahlbergFourVertex_S2_pos_of_forwardDfvSources
    (hsrc : ForwardDfvGeometricSources)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
...
/-- The DFV-source-parametrized S² negative-orientation constant-or-Dahlberg
endpoint. -/
theorem constant_or_dahlbergFourVertex_S2_neg_of_forwardDfvSources
    (hsrc : ForwardDfvGeometricSources)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
...
/-- The DFV-source-parametrized S² negative-orientation nonconstant D4VT
endpoint. -/
theorem dahlbergFourVertex_S2_neg_of_forwardDfvSources
    (hsrc : ForwardDfvGeometricSources)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
...
endpoint. -/
theorem constant_or_dahlbergFourVertex_S2_strict_of_forwardDfvSources
    (hsrc : ForwardDfvGeometricSources)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
...
/-- The DFV-source-parametrized S² strict-orientation nonconstant D4VT endpoint. -/
theorem dahlbergFourVertex_S2_strict_of_forwardDfvSources
    (hsrc : ForwardDfvGeometricSources)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
...
theorem constant_or_dahlbergFourVertex_H2_neg_reflected_of_sources
  ...
  exact constant_or_dahlbergFourVertex_conformalMenger_spaceForm_kernel_of_sources
    hsrc
    (ε := -1) (Or.inr (Or.inr rfl)) hn (ReverseCyclicPolygon v)
    (fun i => -κ (-i)) hdisk' hsimple' horient' hregular' hκ'
...
endpoint, stated for the reflected profile `i ↦ -κ(-i)`. -/
theorem constant_or_dahlbergFourVertex_H2_neg_reflected_of_forwardDfvSources
    (hsrc : ForwardDfvGeometricSources)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
...
/-- The DFV-source-parametrized H² negative-orientation nonconstant D4VT endpoint,
stated for the reflected profile `i ↦ -κ(-i)`. -/
theorem dahlbergFourVertex_H2_neg_reflected_of_forwardDfvSources
    (hsrc : ForwardDfvGeometricSources)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
...
/-- The DFV-source-parametrized H² positive-orientation constant-or-Dahlberg
endpoint. -/
theorem constant_or_dahlbergFourVertex_H2_pos_of_forwardDfvSources
    (hsrc : ForwardDfvGeometricSources)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
...
endpoint. -/
theorem dahlbergFourVertex_H2_pos_of_forwardDfvSources
    (hsrc : ForwardDfvGeometricSources)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
...
/-- The DFV-source-parametrized H² negative-orientation constant-or-Dahlberg
endpoint. -/
theorem constant_or_dahlbergFourVertex_H2_neg_of_forwardDfvSources
    (hsrc : ForwardDfvGeometricSources)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
...
endpoint. -/
theorem dahlbergFourVertex_H2_neg_of_forwardDfvSources
    (hsrc : ForwardDfvGeometricSources)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
...
endpoint. -/
theorem constant_or_dahlbergFourVertex_H2_strict_of_forwardDfvSources
    (hsrc : ForwardDfvGeometricSources)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
...
/-- The DFV-source-parametrized H² strict-orientation nonconstant D4VT endpoint. -/
theorem dahlbergFourVertex_H2_strict_of_forwardDfvSources
    (hsrc : ForwardDfvGeometricSources)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
    ...
    DahlbergFourVertex κ := by
  exact dahlbergFourVertex_of_constant_or_of_not_constant
    (constant_or_dahlbergFourVertex_H2_strict_of_forwardDfvSources
      hsrc hn v κ hdisk hsimple horient hregular hκ)
    hnc
...
primitive source-gate audit. -/
theorem smoothFourVertex_spaceForm_kernel_of_primitiveRemainingSources
    (hsrc : ForwardPrimitiveRemainingSources) {ε : ℝ}
    (hε : ε = 0 ∨ ε = 1 ∨ ε = -1) {γ : ℝ → ℂ} {κ : ℝ → ℝ}
    (hclosed : Gluck.IsSimpleClosed γ)
    (hreal : SmoothForwardRealizes ε γ κ)
    ...
    SmoothFourVertex κ := by
  exact smoothFourVertex_of_fourVertexCondition
    (four_vertex_condition_smooth_spaceForm_kernel_of_primitiveRemainingSources
      hsrc hε hclosed hreal hκ hper)

/-- The Euclidean smooth four-vertex theorem from the flattened primitive
source-gate audit. -/
theorem four_vertex_E2_of_primitiveRemainingSources
    (hsrc : ForwardPrimitiveRemainingSources) {γ : ℝ → ℂ} {κ : ℝ → ℝ}
    (hclosed : Gluck.IsSimpleClosed γ) (hreal : Gluck.RealizesCurvature γ κ)
    (hκ : Continuous κ) (hper : Function.Periodic κ (2 * Real.pi)) :
    SmoothFourVertex κ := by
  exact four_vertex_E2_of_sources
...
source-gate audit. -/
theorem four_vertex_S2_of_primitiveRemainingSources
    (hsrc : ForwardPrimitiveRemainingSources) {γ : ℝ → ℂ} {κ : ℝ → ℝ}
    (hclosed : Gluck.IsSimpleClosed γ)
    (hreal : Gluck.SpaceForm.Realizes 1 γ κ)
    (hκ : Continuous κ) (hper : Function.Periodic κ (2 * Real.pi)) :
...
source-gate audit. -/
theorem four_vertex_H2_of_primitiveRemainingSources
    (hsrc : ForwardPrimitiveRemainingSources) {γ : ℝ → ℂ} {κ : ℝ → ℝ}
    (hclosed : Gluck.IsSimpleClosed γ)
    (hreal : Gluck.SpaceForm.Realizes (-1) γ κ)
    (hκ : Continuous κ) (hper : Function.Periodic κ (2 * Real.pi)) :
...
primitive source-gate audit. -/
theorem constant_or_dahlbergFourVertex_spaceForm_kernel_of_primitiveRemainingSources
    (hsrc : ForwardPrimitiveRemainingSources) {ε : ℝ}
    (hε : ε = 1 ∨ ε = -1) {n : ℕ} [NeZero n]
    (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
...
primitive source-gate audit. -/
theorem constant_or_dahlbergFourVertex_S2_of_primitiveRemainingSources
    (hsrc : ForwardPrimitiveRemainingSources) {n : ℕ} [NeZero n]
    (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
    (hconvex : ∀ i, 0 < Gluck.Discrete.crossR2 (v (i - 1)) (v i) (v (i + 1)))
...
primitive source-gate audit. -/
theorem discrete_four_vertex_S2_of_primitiveRemainingSources
    (hsrc : ForwardPrimitiveRemainingSources) {n : ℕ} [NeZero n]
    (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
...
primitive source-gate audit. -/
theorem constant_or_dahlbergFourVertex_H2_of_primitiveRemainingSources
    (hsrc : ForwardPrimitiveRemainingSources) {n : ℕ} [NeZero n]
    (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
...
primitive source-gate audit. -/
theorem discrete_four_vertex_H2_of_primitiveRemainingSources
    (hsrc : ForwardPrimitiveRemainingSources) {n : ℕ} [NeZero n]
    (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
...
theorem
    constant_or_dahlbergFourVertex_conformalMenger_spaceForm_kernel_of_dfvPrimitiveRemainingSources
    (hsrc : ForwardDfvPrimitiveRemainingSources)
    {ε : ℝ} (hε : ε = 0 ∨ ε = 1 ∨ ε = -1)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
...
positive-orientation branch. -/
theorem dahlbergFourVertex_conformalMenger_spaceForm_kernel_of_dfvPrimitiveRemainingSources
    (hsrc : ForwardDfvPrimitiveRemainingSources)
    {ε : ℝ} (hε : ε = 0 ∨ ε = 1 ∨ ε = -1)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
...
properness in the hyperbolic branch. -/
theorem constant_or_dahlbergFourVertex_conformalMenger_oriented_of_dfvPrimitiveRemainingSources
    (hsrc : ForwardDfvPrimitiveRemainingSources)
    {ε : ℝ} (hε : ε = 0 ∨ ε = 1 ∨ ε = -1)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
...
theorem dahlbergFourVertex_conformalMenger_oriented_of_dfvPrimitiveRemainingSources
    (hsrc : ForwardDfvPrimitiveRemainingSources)
    {ε : ℝ} (hε : ε = 0 ∨ ε = 1 ∨ ε = -1)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
...
theorem constant_or_dahlbergFourVertex_conformalMenger_strict_of_dfvPrimitiveRemainingSources
    (hsrc : ForwardDfvPrimitiveRemainingSources)
    {ε : ℝ} (hε : ε = 0 ∨ ε = 1 ∨ ε = -1)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
...
flattened primitive final-D4VT source-gate audit. -/
theorem dahlbergFourVertex_conformalMenger_strict_of_dfvPrimitiveRemainingSources
    (hsrc : ForwardDfvPrimitiveRemainingSources)
    {ε : ℝ} (hε : ε = 0 ∨ ε = 1 ∨ ε = -1)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
...
flattened primitive final-D4VT source-gate audit. -/
theorem constant_or_dahlbergFourVertex_S2_pos_of_dfvPrimitiveRemainingSources
    (hsrc : ForwardDfvPrimitiveRemainingSources)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
...
primitive final-D4VT source-gate audit. -/
theorem dahlbergFourVertex_S2_pos_of_dfvPrimitiveRemainingSources
    (hsrc : ForwardDfvPrimitiveRemainingSources)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
...
theorem constant_or_dahlbergFourVertex_S2_neg_reflected_of_dfvPrimitiveRemainingSources
    (hsrc : ForwardDfvPrimitiveRemainingSources)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
...
reflected profile, from the flattened primitive final-D4VT source-gate audit. -/
theorem dahlbergFourVertex_S2_neg_reflected_of_dfvPrimitiveRemainingSources
    (hsrc : ForwardDfvPrimitiveRemainingSources)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
...
flattened primitive final-D4VT source-gate audit. -/
theorem constant_or_dahlbergFourVertex_S2_neg_of_dfvPrimitiveRemainingSources
    (hsrc : ForwardDfvPrimitiveRemainingSources)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
...
primitive final-D4VT source-gate audit. -/
theorem dahlbergFourVertex_S2_neg_of_dfvPrimitiveRemainingSources
    (hsrc : ForwardDfvPrimitiveRemainingSources)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
...
primitive final-D4VT source-gate audit. -/
theorem constant_or_dahlbergFourVertex_S2_strict_of_dfvPrimitiveRemainingSources
    (hsrc : ForwardDfvPrimitiveRemainingSources)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
...
primitive final-D4VT source-gate audit. -/
theorem dahlbergFourVertex_S2_strict_of_dfvPrimitiveRemainingSources
    (hsrc : ForwardDfvPrimitiveRemainingSources)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
...
flattened primitive final-D4VT source-gate audit. -/
theorem constant_or_dahlbergFourVertex_H2_pos_of_dfvPrimitiveRemainingSources
    (hsrc : ForwardDfvPrimitiveRemainingSources)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
...
primitive final-D4VT source-gate audit. -/
theorem dahlbergFourVertex_H2_pos_of_dfvPrimitiveRemainingSources
    (hsrc : ForwardDfvPrimitiveRemainingSources)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
...
reflected profile, from the flattened primitive final-D4VT source-gate audit. -/
theorem constant_or_dahlbergFourVertex_H2_neg_reflected_of_dfvPrimitiveRemainingSources
    (hsrc : ForwardDfvPrimitiveRemainingSources)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
...
reflected profile, from the flattened primitive final-D4VT source-gate audit. -/
theorem dahlbergFourVertex_H2_neg_reflected_of_dfvPrimitiveRemainingSources
    (hsrc : ForwardDfvPrimitiveRemainingSources)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
...
flattened primitive final-D4VT source-gate audit. -/
theorem constant_or_dahlbergFourVertex_H2_neg_of_dfvPrimitiveRemainingSources
    (hsrc : ForwardDfvPrimitiveRemainingSources)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
...
primitive final-D4VT source-gate audit. -/
theorem dahlbergFourVertex_H2_neg_of_dfvPrimitiveRemainingSources
    (hsrc : ForwardDfvPrimitiveRemainingSources)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
...
primitive final-D4VT source-gate audit. -/
theorem constant_or_dahlbergFourVertex_H2_strict_of_dfvPrimitiveRemainingSources
    (hsrc : ForwardDfvPrimitiveRemainingSources)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
...
primitive final-D4VT source-gate audit. -/
theorem dahlbergFourVertex_H2_strict_of_dfvPrimitiveRemainingSources
    (hsrc : ForwardDfvPrimitiveRemainingSources)
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hdisk : ∀ i, ‖v i‖ < 1)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
