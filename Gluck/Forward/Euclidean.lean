...
/-- E² strict-orientation constant-profile equivalence: for a simple locally
regular strictly oriented polygon, concyclicity is exactly constancy of the
signed-Menger profile. -/
theorem concyclic_E2_iff_exists_constant_signedMengerProfile_strict_orientation
    {n : ℕ} [NeZero n] (v : ZMod n → ℂ)
    (hsimple : Gluck.Discrete.IsSimplePolygon v) (hregular : DahlbergRegular v)
...
/-- The E² Dahlberg source extraction produces ordered adjacent turns of the
signed-Menger profile for every nonconcyclic locally regular simple polygon. -/
theorem orderedAdjacentTurns_signedMengerProfile_E2_of_not_concyclic
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
    (hregular : DahlbergRegular v) (hnoncircle : ¬ Concyclic v) :
...
theorem orderedAdjacentTurns_E2_of_affine_signedMengerProfile_not_concyclic
  ...
  exact orderedAdjacentTurns_of_eq_affine ha hκ
    (orderedAdjacentTurns_signedMengerProfile_E2_of_not_concyclic
      hn v hsimple hregular hnoncircle)

/-- Nonconcyclic `ε = 0` conformal-Menger realizations inherit the stronger
ordered-turn E² source witness under strict orientation. -/
theorem orderedAdjacentTurns_E2_of_realizesConformalMenger_zero_not_concyclic
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
    (hregular : DahlbergRegular v)
    (horient : PositivePolygonOrientation v ∨ NegativePolygonOrientation v)
    ...
    (hκ : RealizesConformalMenger 0 v κ) :
    OrderedAdjacentTurns κ := by
  exact orderedAdjacentTurns_E2_of_affine_signedMengerProfile_not_concyclic
...
/-- A positive affine change of a nonconstant E² signed-Menger profile
inherits the strict-orientation Dahlberg conclusion. -/
theorem posAffine_signedMengerProfile_dahlbergFourVertex_E2_of_not_constant_strict_orientation
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
    (hregular : DahlbergRegular v)
    (horient : PositivePolygonOrientation v ∨ NegativePolygonOrientation v)
...
/-- Any curvature profile pointwise equal to a positive affine change of a
nonconstant E² signed-Menger profile inherits the strict-orientation Dahlberg
conclusion. -/
theorem dahlbergFourVertex_E2_of_posAffine_signedMengerProfile_signed_not_constant
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
    (hregular : DahlbergRegular v)
    (horient : PositivePolygonOrientation v ∨ NegativePolygonOrientation v)
    ...
    DahlbergFourVertex κ := by
  have hfv :=
    posAffine_signedMengerProfile_dahlbergFourVertex_E2_of_not_constant_strict_orientation
      hn v hsimple hregular horient (a := a) (b := b) ha hnc
  convert hfv using 1
  ext i
  exact hκ i

/-- A nonzero affine change of a nonconstant E² signed-Menger profile inherits
the strict-orientation Dahlberg conclusion. -/
theorem affine_signedMengerProfile_dahlbergFourVertex_E2_of_not_constant
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
    (hregular : DahlbergRegular v)
    (horient : PositivePolygonOrientation v ∨ NegativePolygonOrientation v)
...
/-- Any curvature profile pointwise equal to a nonzero affine change of a
nonconstant E² signed-Menger profile inherits the strict-orientation Dahlberg
conclusion. -/
theorem dahlbergFourVertex_E2_of_affine_signedMengerProfile_signed_not_constant
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
    (hregular : DahlbergRegular v)
    (horient : PositivePolygonOrientation v ∨ NegativePolygonOrientation v)
    ...
    DahlbergFourVertex κ := by
  have hfv :=
    affine_signedMengerProfile_dahlbergFourVertex_E2_of_not_constant
      hn v hsimple hregular horient (a := a) (b := b) ha hnc
  convert hfv using 1
  ext i
  exact hκ i
...
/-- Positive-orientation nonconstant `ε = 0` conformal-Menger endpoint. -/
theorem dahlbergFourVertex_E2_of_realizesConformalMenger_zero_positiveOrientation_not_constant
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
    (hregular : DahlbergRegular v) (horient : PositivePolygonOrientation v)
    (hκ : RealizesConformalMenger 0 v κ)
  ...
  exact dahlbergFourVertex_E2_of_realizesConformalMenger_zero_not_constant_strict_orientation
    hn v κ hsimple hregular (Or.inl horient) hκ hnc

/-- Negative-orientation nonconstant `ε = 0` conformal-Menger endpoint. -/
theorem dahlbergFourVertex_E2_of_realizesConformalMenger_zero_negativeOrientation_not_constant
    {n : ℕ} [NeZero n] (hn : 4 ≤ n) (v : ZMod n → ℂ) (κ : ZMod n → ℝ)
    (hsimple : Gluck.Discrete.IsSimplePolygon v)
    (hregular : DahlbergRegular v) (horient : NegativePolygonOrientation v)
    (hκ : RealizesConformalMenger 0 v κ)
    ...
    DahlbergFourVertex κ := by
  exact dahlbergFourVertex_E2_of_realizesConformalMenger_zero_not_constant_strict_orientation
    hn v κ hsimple hregular (Or.inr horient) hκ hnc
